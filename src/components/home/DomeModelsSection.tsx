        ...
        <div className="relative">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {homeDomeModels.map((model, index) => (
              <article
                key={model.name}
                className="group relative min-h-[17rem] overflow-hidden rounded-xl border border-[#C5A85C]/18 bg-[#08152c]/45 p-6 transition-all hover:border-[#C5A85C]/45 hover:bg-[#08152c]/70"
              >
